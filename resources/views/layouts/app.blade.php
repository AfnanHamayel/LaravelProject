        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <div class="card card-widget widget-user shadow mb-0 pb-0">
                ...
                <div class="widget-user-header bg-info">
                  ...
                  <h5 class="widget-user-desc">{{Auth::user()->Department->name}}</h5>
                </div>
                ...
                <div class="card-footer">
                  <div class="row">
                    <div class="col-sm-6 border-right">
                      <a href="{{route('profile')}}" class="btn btn-info btn-block">Profile</a>
                      <!-- /.description-block -->
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6 ">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('emp_leave')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>My Leaves</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('emp_create_leave')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>New Leave</p>
                </a>
              </li>
